...
private
   ...
   function Get_Find_Pattern (RFR : Rewriter_Find_And_Replace) return Pattern is
     (RFR.F_Find_Pattern);
   ...
   function Make_Rewriter_Find_And_Replace
     ...
     (Rewriter
      with Find_Pattern, Replace_Pattern,
